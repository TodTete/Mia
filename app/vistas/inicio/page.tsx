export default function InicioPage() {
  return (
    <main className="min-h-screen px-6 py-10 sm:px-10 bg-slate-50 dark:bg-black">
      <div className="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-[1.2fr_0.8fr]">
        <section className="card-mia">
        ...
        <section className="card-mia text-slate-950 dark:text-white">
